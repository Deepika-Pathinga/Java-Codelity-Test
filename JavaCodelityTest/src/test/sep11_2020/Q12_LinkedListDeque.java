...
public class Q12_LinkedListDeque {
	 private Node head;
	 private Node tail;
	 ...
	 public static void main(String[] args) {
	  Q12_LinkedListDeque deque = new Q12_LinkedListDeque(); 
	  //deque.getLast();
	  deque.insertFirst(2);  
	  deque.insertFirst(1);
	  deque.insertLast(3);
	  ...
	  Node node1 = deque.removeLast();
	  System.out.println("Node with value "+ node1.i + " deleted");
	  deque.displayForward();
